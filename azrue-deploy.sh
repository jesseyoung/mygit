{
    ...
    "parameters": {
        ...
        "mysqlMasterServer": {
            "type": "string",
            "defaultValue": "actionmaster112"
        },
        "mysqlSlaveServer": {
            "type": "string",
            "defaultValue": "actionslave112"
        },
        "mysqlUser": {
            "type": "string",
            "defaultValue": "action"
    ...
    "resources": [
                ...
                "ipConfigurations": [
                    {
                        ...
                        "properties": {
                            ...
                            "publicIPAddress": {
                                "id": "[resourceId('Microsoft.Network/publicIPAddresses/', parameters('publicIPAddresses_actionDNS'))]"
                            },
                            "subnet": {
        ...
        },
        {
            ...
            "name": "[parameters('publicIPAddresses_actionDNS')]",
            "apiVersion": "2015-06-15",
            "location": "chinaeast",
            "dependsOn": ["[concat('Microsoft.MySql/servers/', parameters('mysqlSlaveServer'))]"],
            "properties": {
                ...
                "dnsSettings": {
                "domainNameLabel": "[parameters('publicIPAddresses_actionDNS')]"
                }
